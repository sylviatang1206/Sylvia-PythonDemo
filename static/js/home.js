...
ns.model = (function() {
    ...
    return {
        ...
        'delete': (lname) => {
            console.log("delete someone222");
            let ajax_options = {
                type: 'DELETE',
                url: `api/deletepeople/${lname}`,
                accepts: 'application/json',
...
ns.controller = (function(m, v) {
    ...
    $('#delete').click(function(e) {
        console.log("delete someone2");

        let person_lname = $lname.val();

        e.preventDefault();

        if (validate('placeholder', person_lname)) {
            model.delete(person_lname)
        } else {
            alert('Problem with first or last name input');
        }
        e.preventDefault();
